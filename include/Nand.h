...
#define NUM_BLOCKS			0x1000	//总共多少
#define SECTOR_SIZE			512		//扇区
#define SPARE_SIZE			16		//额外区域
#define PAGES_PER_BLOCK		32		//页面
...
//这套代码使用的是是Nand_64M_8Bit_K9F1208U0C.pdf
...
// HCLK=100Mhz
#define TACLS				1//1	// 1-clk(0ns) 
#define TWRPH0				1//4	// 3-clk(25ns)
#define TWRPH1				1//0	// 1-clk(10ns)  //TACLS+TWRPH0+TWRPH1>=50ns
